...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between min-h-screen px-4 sm:px-8 md:px-20 py-10 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
